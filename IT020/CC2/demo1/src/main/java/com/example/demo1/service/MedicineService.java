...
public class MedicineService {
    ...
    public List<Medicine> getMedicines(int offset,int sz) {
        Pageable pageableWithSort = PageRequest.of(offset,sz,Sort.by(Sort.Direction.ASC,"medicineId"));
        return medicineRepo.findAll(pageableWithSort).getContent();
    }
